...
func init() {
	...
	md_Denom = File_sixswingchain_tokenfactory_denom_proto.Messages().ByName("Denom")
...
func (x *Denom) slowProtoReflect() protoreflect.Message {
	mi := &file_sixswingchain_tokenfactory_denom_proto_msgTypes[0]
...
func (x *fastReflection_Denom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sixswingchain.tokenfactory.Denom.denom":
		return x.Denom != ""
	case "sixswingchain.tokenfactory.Denom.description":
		return x.Description != ""
	case "sixswingchain.tokenfactory.Denom.ticker":
		return x.Ticker != ""
	case "sixswingchain.tokenfactory.Denom.precision":
		return x.Precision != int32(0)
	case "sixswingchain.tokenfactory.Denom.url":
		return x.Url != ""
	case "sixswingchain.tokenfactory.Denom.maxSupply":
		return x.MaxSupply != int32(0)
	case "sixswingchain.tokenfactory.Denom.supply":
		return x.Supply != int32(0)
	case "sixswingchain.tokenfactory.Denom.canChangeMaxSupply":
		return x.CanChangeMaxSupply != false
	case "sixswingchain.tokenfactory.Denom.owner":
		return x.Owner != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sixswingchain.tokenfactory.Denom"))
		}
		panic(fmt.Errorf("message sixswingchain.tokenfactory.Denom does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Denom) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sixswingchain.tokenfactory.Denom does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Denom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sixswingchain.tokenfactory.Denom.denom":
		panic(fmt.Errorf("field denom of message sixswingchain.tokenfactory.Denom is not mutable"))
	case "sixswingchain.tokenfactory.Denom.description":
		panic(fmt.Errorf("field description of message sixswingchain.tokenfactory.Denom is not mutable"))
	case "sixswingchain.tokenfactory.Denom.ticker":
		panic(fmt.Errorf("field ticker of message sixswingchain.tokenfactory.Denom is not mutable"))
	case "sixswingchain.tokenfactory.Denom.precision":
		panic(fmt.Errorf("field precision of message sixswingchain.tokenfactory.Denom is not mutable"))
	case "sixswingchain.tokenfactory.Denom.url":
		panic(fmt.Errorf("field url of message sixswingchain.tokenfactory.Denom is not mutable"))
	case "sixswingchain.tokenfactory.Denom.maxSupply":
		panic(fmt.Errorf("field maxSupply of message sixswingchain.tokenfactory.Denom is not mutable"))
	case "sixswingchain.tokenfactory.Denom.supply":
		panic(fmt.Errorf("field supply of message sixswingchain.tokenfactory.Denom is not mutable"))
	case "sixswingchain.tokenfactory.Denom.canChangeMaxSupply":
		panic(fmt.Errorf("field canChangeMaxSupply of message sixswingchain.tokenfactory.Denom is not mutable"))
	case "sixswingchain.tokenfactory.Denom.owner":
		panic(fmt.Errorf("field owner of message sixswingchain.tokenfactory.Denom is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sixswingchain.tokenfactory.Denom"))
		}
...
func (x *fastReflection_Denom) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sixswingchain.tokenfactory.Denom", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Denom) Descriptor() ([]byte, []int) {
	return file_sixswingchain_tokenfactory_denom_proto_rawDescGZIP(), []int{0}
}
...
var File_sixswingchain_tokenfactory_denom_proto protoreflect.FileDescriptor

var file_sixswingchain_tokenfactory_denom_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1a, 0x73, 0x69, 0x78, 0x73, 0x77, 0x69,
	...
	,
}

var (
	file_sixswingchain_tokenfactory_denom_proto_rawDescOnce sync.Once
	file_sixswingchain_tokenfactory_denom_proto_rawDescData = file_sixswingchain_tokenfactory_denom_proto_rawDesc
)

func file_sixswingchain_tokenfactory_denom_proto_rawDescGZIP() []byte {
	file_sixswingchain_tokenfactory_denom_proto_rawDescOnce.Do(func() {
		file_sixswingchain_tokenfactory_denom_proto_rawDescData = protoimpl.X.CompressGZIP(file_sixswingchain_tokenfactory_denom_proto_rawDescData)
	})
	return file_sixswingchain_tokenfactory_denom_proto_rawDescData
}

var file_sixswingchain_tokenfactory_denom_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_sixswingchain_tokenfactory_denom_proto_goTypes = []interface{}{
	(*Denom)(nil), // 0: sixswingchain.tokenfactory.Denom
}
var file_sixswingchain_tokenfactory_denom_proto_depIdxs = []int32{
...
func init() { file_sixswingchain_tokenfactory_denom_proto_init() }
func file_sixswingchain_tokenfactory_denom_proto_init() {
	if File_sixswingchain_tokenfactory_denom_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_sixswingchain_tokenfactory_denom_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Denom); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_sixswingchain_tokenfactory_denom_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sixswingchain_tokenfactory_denom_proto_goTypes,
		DependencyIndexes: file_sixswingchain_tokenfactory_denom_proto_depIdxs,
		MessageInfos:      file_sixswingchain_tokenfactory_denom_proto_msgTypes,
	}.Build()
	File_sixswingchain_tokenfactory_denom_proto = out.File
	file_sixswingchain_tokenfactory_denom_proto_rawDesc = nil
	file_sixswingchain_tokenfactory_denom_proto_goTypes = nil
	file_sixswingchain_tokenfactory_denom_proto_depIdxs = nil
}
